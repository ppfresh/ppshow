...
use app\back\validate\AttributeGroupCreate;
use app\back\validate\AttributeGroupSet;
use think\Config;
...
class AttributeGroup extends Controller
{
    ...
    public function set($id=null)
    {
        ...
        if ($request->isGet()) {
            // 属性组数据, 可能没有
            $row = AttributeGroupModel::get($id);
...
//            $data = $request->post();   //请求对象的方式
            ...
            //2.校验数据
            $volidate = new AttributeGroupSet();
            ...
            if (empty($id)) {
                ...
                $model = AttributeGroupModel::get($id);
            }
    ...
    public function batch()
    {
        ...
        //dump($ids);die;
        AttributeGroupModel::destroy($ids);
