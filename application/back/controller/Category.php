...
use app\back\validate\CategoryCreate;
use app\back\validate\CategorySet;
use think\Config;
    ...
    public function set($id=null)
    {
        ...
        if ($request->isGet()) {
            ...
            return $this->fetch('set', [
                ...
                'categorise'=>  (new CategoryModel())->getTree()
            ]);
        }
        #   post提交
...
//            $data = $request->post();   //请求对象的方式
    ...
    public function index()
    {
        ...
        //对查询出的数据进行处理,生成树状结构
        $rows = (new CategoryModel())->getTree();
