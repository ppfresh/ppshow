...
use app\back\validate\%key%Create;
use app\back\validate\%key%Set;
use think\Config;
use think\Controller;
use think\Request;
use app\back\model\%key% as %key%Model;
use think\Session;
use think\Validate;
